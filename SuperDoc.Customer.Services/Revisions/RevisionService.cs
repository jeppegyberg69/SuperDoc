...
namespace SuperDoc.Customer.Services.Revisions
{
    public class RevisionService : IRevisionService
    {
        ...
        public RevisionService(IRevisionRepository revisionRepository, IUserRepository userRepository, IDocumentRepository documentRepository, IDocumentSignatureRepository documentSignatureRepository)
        {
